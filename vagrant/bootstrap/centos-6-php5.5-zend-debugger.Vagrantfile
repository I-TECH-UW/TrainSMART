...
# CentOS x86_64 6.6 PHP 5.5.xx with Zend Debugger
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.hostname = "centos6-php55-zend"
  ...
  config.vm.provision "file", source: "vagrant/bootstrap/ZendDebugger-php5.5.so", destination: "/home/vagrant/ZendDebugger.so"
...
#  config.vm.provision "file", source: "vagrant/bootstrap/mysqld.init.d", destination: "/home/vagrant/mysqld.init"
  ...
  config.vm.provision :shell, path: "vagrant/bootstrap/bootstrap-centos6-php55-zend-debugger.sh"
