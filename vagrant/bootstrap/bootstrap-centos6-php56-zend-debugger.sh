...
yum update -y
yum install yum-plugin-replace nano dkms php php-devel php-mbstring php-gd php-xml php-mysql mysql-server mysql-devel git-core dos2unix telnet nano mod_ssl -y
