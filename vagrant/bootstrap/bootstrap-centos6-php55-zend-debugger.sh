...
# copy repository config that enables legacy php (5.5) installation
...
yum replace php --replace-with php55u -y

# install the Zend Debugger for php 5.5
