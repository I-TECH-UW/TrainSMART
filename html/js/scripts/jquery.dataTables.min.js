...
(function(i, oa, t, p) {
	var m = function(h) {
		function n(a, b) {
			var c = m.defaults.columns, d = a.aoColumns.length;
			...
			a.aoColumns.push(b);
			if (a.aoPreSearchCols[d] === p || a.aoPreSearchCols[d] === null)
				a.aoPreSearchCols[d] = i.extend({}, m.models.oSearch);
			else {
				...
				for (e = b.length - 1; e >= 0; e--) {
					...
					for (g = k.length; f < g; f++)
						if (typeof k[f] === "number" && k[f] >= 0) {
							for (; a.aoColumns.length <= k[f];)
								n(a);
							d(k[f], b[e])
						} else if (typeof k[f] === "number" && k[f] < 0)
							d(a.aoColumns.length + k[f], b[e]);
						else if (typeof k[f] === "string") {
							j = 0;
							for (l = a.aoColumns.length; j < l; j++)
								if (k[f] == "_all"
										|| i(a.aoColumns[j].nTh).hasClass(k[f]))
									d(j, b[e])
						}
				}
			if (c) {
		...
		function O(a, b) {
			...
			for ( var d, e = 0, f = a.aoColumns.length; e < f; e++) {
				...
				typeof c.fnRender === "function" && c.bUseRendered
						&& c.mDataProp !== null && S(a, b, e, ba(a, b, e));
				if (c._bAutoType && c.sType != "string") {
					...
					if (d !== null && d !== "") {
						...
						if (c.sType === null)
							c.sType = d;
						else if (c.sType != d && c.sType != "html")
							c.sType = "string"
					}
				}
			}
		...
		function ia(a) {
			...
			for (j = a.aoColumns.length; e < j; e++) {
				k = a.aoColumns[e];
				if (k.sTitle === null)
					k.sTitle = k.nTh.innerHTML;
				f = k._bAutoType;
				l = typeof k.fnRender === "function";
				var y = k.sClass !== null, u = k.bVisible, v, A;
				if (f || l || y || !u) {
					b = 0;
					for (c = a.aoData.length; b < c; b++) {
						...
						if (f && k.sType != "string") {
							...
							if (A !== "") {
								...
								if (k.sType === null)
									k.sType = A;
								else if (k.sType != A && k.sType != "html")
									k.sType = "string"
							}
						}
						if (typeof k.mDataProp === "function")
							v.innerHTML = E(a, b, e, "display");
						if (l) {
							A = ba(a, b, e);
							v.innerHTML = A;
						...
						k.fnCreatedCell
								&& k.fnCreatedCell.call(a.oInstance, v, E(a, b,
										e, "display"), d._aData, b, e)
					}
				}
			}
		...
		function E(a, b, c, d) {
			...
			if ((c = e.fnGetData(a.aoData[b]._aData, d)) === p) {
				if (a.iDrawError != a.iDraw && e.sDefaultContent === null) {
					N(a, 0, "Requested unknown parameter '" + e.mDataProp
			...
			if (c.nTr === null) {
				...
				for ( var e = 0, f = a.aoColumns.length; e < f; e++) {
					...
					d.innerHTML = typeof g.fnRender === "function"
							&& (!g.bUseRendered || g.mDataProp === null) ? ba(
							a, b, e) : E(a, b, e, "display");
					if (g.sClass !== null)
					...
					if (g.bVisible) {
						...
						c._anHidden[e] = d;
					g.fnCreatedCell
							&& g.fnCreatedCell.call(a.oInstance, d, E(a, b, e,
									"display"), c._aData, b, e)
				}
		...
		function Ha(a) {
			...
			if (a.oFeatures.bSort)
				for (b = 0; b < a.aoColumns.length; b++)
					a.aoColumns[b].bSortable !== false ? ua(a,
							a.aoColumns[b].nTh, b) : i(a.aoColumns[b].nTh)
				...
				for (d = a.aoColumns.length; b < d; b++)
					if (c[b]) {
						...
						a.aoColumns[b].sClass
								&& i(c[b]).addClass(a.aoColumns[b].sClass)
					}
			}
		}
		function ea(a, b, c) {
			var d, e, f, g = [], j = [], l = a.aoColumns.length, k;
			if (c === p)
				c = false;
			d = 0;
			...
			for (e = g.length; d < e; d++) {
				...
				for (b = g[d].length; f < b; f++) {
					...
					if (j[d][f] === p) {
						...
						for (j[d][f] = 1; g[d + l] !== p
								&& g[d][f].cell == g[d + l][f].cell;) {
							j[d + l][f] = 1;
							l++
						}
						for (; g[d][f + k] !== p
								&& g[d][f].cell == g[d][f + k].cell;) {
							for (c = 0; c < l; c++)
								j[d + c][f + k] = 1;
							k++
						}
			...
			if (i.inArray(false, c) === -1) {
				...
				if (a.aiDisplay.length !== 0) {
					...
					for (g = g; g < c; g++) {
						...
						L(a, "aoRowCallback", null, [ l,
								a.aoData[a.aiDisplay[g]]._aData, e, g ]);
						d.push(l);
						e++;
						if (b !== 0)
							for (j = 0; j < b; j++)
								if (l == a.aoOpenRows[j].nParent) {
					...
					f = a.oLanguage.sZeroRecords.replace("_MAX_", a
							.fnFormatNumber(a.fnRecordsTotal()));
					if (a.iDraw == 1 && a.sAjaxSource !== null
							&& !a.oFeatures.bServerSide)
						f = a.oLanguage.sLoadingRecords;
					else if (a.oLanguage.sEmptyTable
							&& a.fnRecordsTotal() === 0)
						f = a.oLanguage.sEmptyTable;
				...
				L(a, "aoHeaderCallback", "header", [
						i(a.nTHead).children("tr")[0], ka(a), a._iDisplayStart,
						a.fnDisplayEnd(), a.aiDisplay ]);
				L(a, "aoFooterCallback", "footer", [
						i(a.nTFoot).children("tr")[0], ka(a), a._iDisplayStart,
						a.fnDisplayEnd(), a.aiDisplay ]);
		...
		function Ja(a) {
			...
			a.nTableWrapper = i('<div id="' + a.sTableId + '_wrapper" class="'
					+ a.oClasses.sWrapper + '" role="grid"></div>')[0];
			...
			for ( var c = a.nTableWrapper, d = a.sDom.split(""), e, f, g, j, l, k, y, u = 0; u < d.length; u++) {
				...
				if (g == "<") {
					...
					if (l == "'" || l == '"') {
						...
						if (k == "H")
							k = "fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix";
						else if (k == "F")
							k = "fg-toolbar ui-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-helper-clearfix";
						if (k.indexOf(".") != -1) {
							l = k.split(".");
							j.id = l[0].substr(1, l[0].length - 1);
							j.className = l[1]
						} else if (k.charAt(0) == "#")
							j.id = k.substr(1, k.length - 1);
						else
							j.className = k;
						u += y
					}
			...
			for (j = b.length; d < j; d++) {
				...
				for (l = b[d].childNodes.length; e < l; e++) {
					...
					if (c.nodeName.toUpperCase() == "TD"
						...
						var u = c.getAttribute("colspan") * 1, v = c
		...
		function Qa(a) {
			var b = a.aoColumns.length, c = [], d, e;
			c.push({
				name : "sEcho",
				value : a.iDraw
			});
		...
		function Ra(a, b) {
			...
			for ( var e = 0, f = b.length; e < f; e++)
				if (c) {
					for ( var g = [], j = 0, l = a.aoColumns.length; j < l; j++)
						g.push(b[e][d[j]]);
					O(a, g)
				} else
					O(a, b[e]);
		...
		function La(a) {
			...
			c.bind("keyup.DT", function() {
				for ( var e = a.aanFeatures.f, f = 0, g = e.length; f < g; f++)
					e[f] != i(this).parents("div.dataTables_filter")[0]
							&& i("input", e[f]).val(this.value);
		...
		function U(a, b, c) {
			...
			if (a.oFeatures.bServerSide)
				...
				for (b = 0; b < a.aoPreSearchCols.length; b++)
					Ta(a, e[b].sSearch, b, e[b].bRegex, e[b].bSmart,
		...
		function Ua(a) {
			for ( var b = m.ext.afnFiltering, c = 0, d = b.length; c < d; c++)
		...
		function Ta(a, b, c, d, e, f) {
			if (b !== "") {
				...
				for (d = a.aiDisplay.length - 1; d >= 0; d--) {
					e = ya(E(a, a.aiDisplay[d], c, "filter"),
							a.aoColumns[c].sType);
					if (!b.test(e)) {
		...
		function Sa(a, b, c, d, e, f) {
			...
			e = a.oPreviousSearch;
			c || (c = 0);
			if (m.ext.afnFiltering.length !== 0)
				c = 1;
			if (b.length <= 0) {
				a.aiDisplay.splice(0, a.aiDisplay.length);
				a.aiDisplay = a.aiDisplayMaster.slice()
			} else if (a.aiDisplay.length == a.aiDisplayMaster.length
					|| e.sSearch.length > b.length || c == 1
		...
		function wa(a, b) {
			if (!a.oFeatures.bServerSide) {
				...
				for ( var c = 0, d = b.length; c < d; c++)
					a.asDataSearch[c] = za(a, ja(a, b[c], "filter"))
			}
		}
		function za(a, b) {
			var c = "";
			if (a.__nTmpFilter === p)
				a.__nTmpFilter = t.createElement("div");
			for ( var d = a.__nTmpFilter, e = 0, f = a.aoColumns.length; e < f; e++)
				if (a.aoColumns[e].bSearchable)
					c += ya(b[e], a.aoColumns[e].sType) + "  ";
			if (c.indexOf("&") !== -1) {
				d.innerHTML = c;
		...
		function ya(a, b) {
			if (typeof m.ext.ofnSearch[b] === "function")
				return m.ext.ofnSearch[b](a);
			else if (b == "html")
				return a.replace(/[\r\n]/g, " ").replace(/<.*?>/g, "");
		...
		function Va(a) {
			if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
				var b = a._iDisplayStart + 1, c = a.fnDisplayEnd(), d = a
						.fnRecordsTotal(), e = a.fnRecordsDisplay(), f = a
						.fnFormatNumber(b), g = a.fnFormatNumber(c), j = a
						.fnFormatNumber(d), l = a.fnFormatNumber(e);
				if (a.oScroll.bInfinite)
					f = a.fnFormatNumber(1);
				f = a.fnRecordsDisplay() === 0
						...
						: a.fnRecordsDisplay() === 0 ? a.oLanguage.sInfoEmpty
								...
								: a.fnRecordsDisplay() == a.fnRecordsTotal() ? a.oLanguage.sInfo
										.replace("_START_", f).replace("_END_",
												g).replace("_TOTAL_", l)
										+ a.oLanguage.sInfoPostFix
										: a.oLanguage.sInfo.replace("_START_",
												f).replace("_END_", g).replace(
												"_TOTAL_", l)
												+ " "
				...
				if (a.oLanguage.fnInfoCallback !== null)
					f = a.oLanguage.fnInfoCallback.call(a.oInstance, a, b, c,
							d, e, f);
				a = a.aanFeatures.i;
				b = 0;
		...
		function Ba(a) {
			!a.sEmptyTable && a.sZeroRecords
					&& q(a, a, "sZeroRecords", "sEmptyTable");
			!a.sLoadingRecords && a.sZeroRecords
					&& q(a, a, "sZeroRecords", "sLoadingRecords")
		}
		function Ka(a) {
			if (a.oScroll.bInfinite)
				return null;
			...
			i('select option[value="' + a._iDisplayLength + '"]', e).attr(
					"selected", true);
		...
		function Pa(a) {
			...
			a.aanFeatures.p
					|| a.aoDrawCallback.push({
						fn : function(c) {
							m.ext.oPagination[c.sPaginationType].fnUpdate(c,
									function(d) {
										J(d);
										H(d)
									})
		...
		function Na(a) {
			if (a.oScroll.sX === "" && a.oScroll.sY === "")
				return a.nTable;
			var b = t.createElement("div"), c = t.createElement("div"), d = t
					.createElement("div"), e = t.createElement("div"), f = t
					.createElement("div"), g = t.createElement("div"), j = a.nTable
					.cloneNode(false), l = a.nTable.cloneNode(false), k = a.nTable
					.getElementsByTagName("thead")[0], y = a.nTable
					.getElementsByTagName("tfoot").length === 0 ? null
					: a.nTable.getElementsByTagName("tfoot")[0], u = a.oClasses;
			c.appendChild(d);
			f.appendChild(g);
		...
		function Wa(a) {
			var b = a.nScrollHead.getElementsByTagName("div")[0], c = b
					.getElementsByTagName("table")[0], d = a.nTable.parentNode, e, f, g, j, l, k, y, u, v = [], A = a.nTFoot !== null ? a.nScrollFoot
					.getElementsByTagName("div")[0]
					: null, Y = a.nTFoot !== null ? A
					.getElementsByTagName("table")[0] : null, C = i.browser.msie
					&& i.browser.version <= 7;
			...
			if (a.oScroll.sX === "") {
				...
				if (C
						&& (i("tbody", d).height() > d.offsetHeight || i(d)
								.css("overflow-y") == "scroll"))
					a.nTable.style.width = s(i(a.nTable).outerWidth()
							- a.oScroll.iBarWidth)
			} else if (a.oScroll.sXInner !== "")
				a.nTable.style.width = s(a.oScroll.sXInner);
			...
			if (i(a.nTable).outerWidth() < e) {
				...
				if (C
						&& (d.scrollHeight > d.offsetHeight || i(d).css(
								"overflow-y") == "scroll"))
					a.nTable.style.width = s(j - a.oScroll.iBarWidth);
				d.style.width = s(j);
				b.parentNode.style.width = s(j);
				if (a.nTFoot !== null)
					A.parentNode.style.width = s(j);
				if (a.oScroll.sX === "")
					N(
							a,
							1,
				...
				if (a.nTFoot !== null)
					A.parentNode.style.width = s("100%")
			}
			if (a.oScroll.sY === "")
				if (C)
					d.style.height = s(a.nTable.offsetHeight
							+ a.oScroll.iBarWidth);
			if (a.oScroll.sY !== "" && a.oScroll.bCollapse) {
				d.style.height = s(a.oScroll.sY);
				C = a.oScroll.sX !== "" && a.nTable.offsetWidth > d.offsetWidth ? a.oScroll.iBarWidth
						: 0;
				if (a.nTable.offsetHeight < d.offsetHeight)
					d.style.height = s(i(a.nTable).height() + C)
			}
		...
		function V(a, b, c) {
			for ( var d = 0, e = b.length; d < e; d++)
				for ( var f = 0, g = b[d].childNodes.length; f < g; f++)
					if (b[d].childNodes[f].nodeType == 1)
						c ? a(b[d].childNodes[f], c[d].childNodes[f])
								: a(b[d].childNodes[f])
		}
		function Xa(a, b) {
			if (!a || a === null || a === "")
		...
		function pa(a) {
			var b = 0, c, d = 0, e = a.aoColumns.length, f, g = i("th",
					a.nTHead), j = a.nTable.getAttribute("width");
			for (f = 0; f < e; f++)
				if (a.aoColumns[f].bVisible) {
					...
					if (a.aoColumns[f].sWidth !== null) {
						...
						if (c !== null)
							a.aoColumns[f].sWidth = s(c);
						b++
					}
				}
			if (e == g.length && b === 0 && d == e && a.oScroll.sX === ""
					&& a.oScroll.sY === "")
				...
				for (f = d = 0; f < e; f++) {
					var l = a.aoColumns[f];
					if (l.bVisible && l.sWidthOrig !== null
							&& l.sWidthOrig !== "")
						g[f - d].style.width = s(l.sWidthOrig);
					else if (l.bVisible)
						g[f - d].style.width = "";
					else
						d++
				...
				if (a.oScroll.sX !== "" && a.oScroll.sXInner !== "")
					b.style.width = s(a.oScroll.sXInner);
				else if (a.oScroll.sX !== "") {
					b.style.width = "";
					if (i(b).width() < e.offsetWidth)
						b.style.width = s(e.offsetWidth)
				...
				if (a.oScroll.sX !== "") {
					for (f = d = c = 0; f < a.aoColumns.length; f++)
						if (a.aoColumns[f].bVisible) {
							c += a.aoColumns[f].sWidthOrig === null ? i(e[d])
									.outerWidth()
									: parseInt(a.aoColumns[f].sWidth.replace(
											"px", ""), 10)
											+ (i(e[d]).outerWidth() - i(e[d])
													.width());
							d++
						}
					b.style.width = s(c);
				...
				e = i(b).css("width");
				a.nTable.style.width = e.indexOf("%") !== -1 ? e : s(i(b)
						.outerWidth());
				b.parentNode.removeChild(b)
			}
			if (j)
				a.nTable.style.width = s(j)
		}
		function Za(a, b) {
			if (a.oScroll.sX === "" && a.oScroll.sY !== "") {
				i(b).width();
				...
				b.style.width = s(i(b).outerWidth())
		}
		function Ya(a, b) {
			var c = $a(a, b);
			if (c < 0)
		...
		function X(a, b) {
			var c, d, e, f, g, j, l = [], k = [], y = m.ext.oSort, u = a.aoData, v = a.aoColumns, A = a.oLanguage.oAria;
			if (!a.oFeatures.bServerSide
					&& (a.aaSorting.length !== 0 || a.aaSortingFixed !== null)) {
				l = a.aaSortingFixed !== null ? a.aaSortingFixed
				...
				for (d = u.length; c < d; c++)
					for (e = 0; e < Y; e++) {
						...
						for (j = C.length; g < j; g++) {
							f = v[C[g]].sType;
							f = y[(f ? f : "string") + "-pre"];
							u[c]._aSortData[C[g]] = f ? f(E(a, c, C[g], "sort"))
									: E(a, c, C[g], "sort")
						}
					}
			...
			for (d = a.aoColumns.length; c < d; c++) {
				...
				if (v[c].bSortable)
					if (l.length > 0 && l[0][0] == c) {
						b.setAttribute("aria-sort",
								l[0][1] == "asc" ? "ascending" : "descending");
						b
								.setAttribute(
										"aria-label",
										v[c].sTitle
												+ ((v[c].asSorting[l[0][2] + 1] ? v[c].asSorting[l[0][2] + 1]
														: v[c].asSorting[0]) == "asc" ? A.sSortAscending
														: A.sSortDescending))
					} else
						b
								.setAttribute(
					...
					b.setAttribute("aria-label", v[c].sTitle)
			}
			a.bSorted = true;
			i(a.oInstance).trigger("sort", a);
			if (a.oFeatures.bFilter)
				U(a, a.oPreviousSearch, 1);
			else {
				a.aiDisplay = a.aiDisplayMaster.slice();
				a._iDisplayStart = 0;
				J(a);
					...
					function(e) {
						if (a.aoColumns[c].bSortable !== false) {
							var f = function() {
								var g, j;
								if (e.shiftKey) {
									for ( var l = false, k = 0; k < a.aaSorting.length; k++)
		...
		function aa(a) {
			...
			e = a.aaSortingFixed !== null ? a.aaSortingFixed
					.concat(a.aaSorting) : a.aaSorting.slice();
			for (b = 0; b < a.aoColumns.length; b++)
				if (a.aoColumns[b].bSortable) {
				...
				if (a.oFeatures.bDeferRender)
					...
					for (b = 0; b < g; b++)
						if (d[b].className.indexOf(f + "1") != -1) {
							c = 0;
							for (a = d.length / g; c < a; c++)
								d[g * c + b].className = i
										.trim(d[g * c + b].className.replace(f
												+ "1", ""))
							...
							for (a = d.length / g; c < a; c++)
								d[g * c + b].className = i
										.trim(d[g * c + b].className.replace(
												" " + f + "3", ""))
						}
				j = 1;
				var l;
		...
		function db(a, b) {
			if (a.oFeatures.bStateSave) {
				...
				if (c) {
					var d = L(a, "aoStateLoadParams", "stateLoadParams",
							[ a, c ]);
		...
		function ib(a, b, c, d, e) {
			...
			var g;
			if (e !== null) {
				g = typeof i.parseJSON === "function" ? i.parseJSON(b)
						: eval("(" + b + ")");
		...
		function z(a) {
			for ( var b = 0; b < m.settings.length; b++)
				if (m.settings[b].nTable === a)
					return m.settings[b];
			return null
		}
		function ca(a) {
		...
		function N(a, b, c) {
			a = a === null ? "DataTables warning: " + c
					: "DataTables warning (table id = '" + a.sTableId + "'): "
							+ c;
			if (b === 0)
				if (m.ext.sErrMode == "alert")
					alert(a);
				else
					throw a;
			else
				console !== p && console.log && console.log(a)
		}
		function q(a, b, c, d) {
			if (d === p)
				d = c;
		...
		function fb(a, b) {
			for ( var c in a)
				if (a.hasOwnProperty(c) && b[c] !== p)
					if (typeof h[c] === "object" && i.isArray(b[c]) === false)
						i.extend(true, a[c], b[c]);
					else
						a[c] = b[c];
			return a
		}
		...
		this.$ = function(a, b) {
			var c, d = [], e = z(this[m.ext.iApiIndex]);
			b || (b = {});
			b = i.extend({}, {
				filter : "none",
				order : "current",
			...
			if (b.page == "current") {
				b = e._iDisplayStart;
				for (c = e.fnDisplayEnd(); b < c; b++)
					d.push(e.aoData[e.aiDisplay[b]].nTr)
			} else if (b.order == "current" && b.filter == "none") {
				b = 0;
				for (c = e.aiDisplayMaster.length; b < c; b++)
					d.push(e.aoData[e.aiDisplayMaster[b]].nTr)
			} else if (b.order == "current" && b.filter == "applied") {
				b = 0;
				for (c = e.aiDisplay.length; b < c; b++)
					d.push(e.aoData[e.aiDisplay[b]].nTr)
			} else if (b.order == "original" && b.filter == "none") {
				b = 0;
				for (c = e.aoData.length; b < c; b++)
					d.push(e.aoData[b].nTr)
			} else if (b.order == "original" && b.filter == "applied") {
				b = 0;
				for (c = e.aoData.length; b < c; b++)
					i.inArray(b, e.aiDisplay) !== -1 && d.push(e.aoData[b].nTr)
			} else
		...
		this.fnClose = function(a) {
			for ( var b = z(this[m.ext.iApiIndex]), c = 0; c < b.aoOpenRows.length; c++)
		...
		this.fnDeleteRow = function(a, b, c) {
			var d = z(this[m.ext.iApiIndex]), e, f;
		...
		this.fnDestroy = function(a) {
			var b = z(this[m.ext.iApiIndex]), c = b.nTableWrapper.parentNode, d = b.nTBody, e, f;
			a = a === p ? false : true;
			b.bDestroying = true;
			e = 0;
			for (f = b.aoDestroyCallback.length; e < f; e++)
				b.aoDestroyCallback[e].fn();
			e = 0;
			...
			i("tbody>tr>td." + b.oClasses.sRowEmpty, b.nTable).parent()
					.remove();
			...
			if (b.bJUI) {
				i(
						"th span." + b.oClasses.sSortIcon + ", td span."
								+ b.oClasses.sSortIcon, b.nTHead).remove();
				i("th, td", b.nTHead)
						.each(
								function() {
									var g = i("div."
											+ b.oClasses.sSortJUIWrapper, this), j = g
											.contents();
									i(this).append(j);
									g.remove()
								})
			...
			if (b.oFeatures.bAutoWidth === true)
				b.nTable.style.width = s(b.sDestroyWidth);
			i(d).children("tr:even").addClass(b.asDestroyStripes[0]);
			i(d).children("tr:odd").addClass(b.asDestroyStripes[1]);
			e = 0;
			for (f = m.settings.length; e < f; e++)
				m.settings[e] == b && m.settings.splice(e, 1);
			b = null
		};
		...
		this.fnGetPosition = function(a) {
			var b = z(this[m.ext.iApiIndex]), c = a.nodeName.toUpperCase();
			if (c == "TR")
				return M(b, a);
			else if (c == "TD" || c == "TH") {
				c = M(b, a.parentNode);
		...
		this.fnOpen = function(a, b, c) {
			var d = z(this[m.ext.iApiIndex]), e = ca(d);
			if (i.inArray(a, e) !== -1) {
				this.fnClose(a);
		...
		this.fnSetColumnVis = function(a, b, c) {
			var d = z(this[m.ext.iApiIndex]), e, f, g = d.aoColumns, j = d.aoData, l, k;
			if (g[a].bVisible != b) {
				if (b) {
					for (e = f = 0; e < a; e++)
						g[e].bVisible && f++;
					...
					for (f = j.length; e < f; e++)
						if (j[e].nTr !== null)
							k ? j[e].nTr.appendChild(j[e]._anHidden[a])
									: j[e].nTr.insertBefore(j[e]._anHidden[a],
											T(d, e)[l])
				} else {
					e = 0;
					for (f = j.length; e < f; e++)
				...
				for (f = d.aoOpenRows.length; e < f; e++)
					d.aoOpenRows[e].nTr.colSpan = B(d);
				if (c === p || c) {
					o(d);
					H(d)
				}
		...
		this.fnUpdate = function(a, b, c, d, e) {
			...
			if (f.__fnUpdateDeep === p && i.isArray(a) && typeof a === "object") {
				...
				for (c = 0; c < f.aoColumns.length; c++)
					this.fnUpdate(E(f, b, c), b, c, false, false);
				f.__fnUpdateDeep = p
			} else if (f.__fnUpdateDeep === p && a !== null
					&& typeof a === "object") {
				...
				.each(function() {
					...
					if (this.nodeName.toLowerCase() != "table")
						...
						for (b = m.settings.length; a < b; a++) {
							if (m.settings[a].nTable == this)
								if (h === p || h.bRetrieve)
									return m.settings[a].oInstance;
								else if (h.bDestroy) {
						...
						if (c === null)
							this.id = c = "DataTables_Table_"
									+ m.ext._oExternConfig.iNextUnique++;
						...
						m.settings.push(g);
						g.oInstance = Fa.length === 1 ? Fa : i(this)
								.dataTable();
						h || (h = {});
						...
						if (g.oFeatures.bServerSide && g.oFeatures.bSort
								&& g.oFeatures.bSortClasses)
							K(g, "aoDrawCallback", aa,
						...
						if (h.bJQueryUI) {
							...
							if (h.sDom === m.defaults.sDom
									&& m.defaults.sDom === "lfrtip")
								g.sDom = '<"H"lfr>t<"F"ip>'
						} else
							i.extend(g.oClasses, m.ext.oStdClasses);
						i(this).addClass(g.oClasses.sTable);
						if (g.oScroll.sX !== "" || g.oScroll.sY !== "")
							g.oScroll.iBarWidth = ab();
						...
						if (c) {
							g.asDestroyStripes = [ "", "" ];
							if (i(d[0]).hasClass(g.oClasses.sStripeOdd))
								g.asDestroyStripes[0] += g.oClasses.sStripeOdd
										+ " ";
							if (i(d[0]).hasClass(g.oClasses.sStripeEven))
								g.asDestroyStripes[0] += g.oClasses.sStripeEven;
							if (i(d[1]).hasClass(g.oClasses.sStripeOdd))
								g.asDestroyStripes[1] += g.oClasses.sStripeOdd
										+ " ";
							if (i(d[1]).hasClass(g.oClasses.sStripeEven))
	...
	m.defaults = {
		...
		fnFormatNumber : function(h) {
			...
			for ( var o = 0; o < n; o++) {
				if (o % 3 === 0 && o !== 0)
					r = this.oLanguage.sInfoThousands + r;
				r = h[n - o - 1] + r
			}
			return r
		},
		...
		fnStateSave : function(h, n) {
			this.oApi._fnCreateCookie(h.sCookiePrefix + h.sInstance, this.oApi
					._fnJsonString(n), h.iCookieDuration, h.sCookiePrefix,
					h.fnCookieCallback)
		},
		...
		oLanguage : {
			oAria : {
				sSortAscending : ": " + tr("activate to sort column ascending"),
				sSortDescending : ": " + tr("activate to sort column descending")
			},
			oPaginate : {
				sFirst : tr("First"),
				sLast : tr("Last"),
				sNext : tr("Next"),
				sPrevious : tr("Previous")
			},
			sEmptyTable : tr("No data available in table"),
			sInfo : tr("Showing _START_ to _END_ of _TOTAL_ entries"),
			sInfoEmpty : tr("Showing 0 to 0 of 0 entries"),
			sInfoFiltered : "(" + tr("filtered from _MAX_ total entries") + ")",
			sInfoPostFix : "",
			sInfoThousands : ",",
			sLengthMenu : tr("Show _MENU_ entries"),
			sLoadingRecords : tr("Loading..."),
			sProcessing : tr("Processing..."),
			sSearch : tr("Search") + ":",
			sUrl : "",
			sZeroRecords : tr("No matching records found")
		},
					...
					m.ext.oPagination,
					{
						two_button : {
							fnInit : function(h, n, r) {
								var o = h.oLanguage.oPaginate, w = function(B) {
									h.oApi._fnPageChange(h, B.data.action)
											&& r(h)
								};
								o = !h.bJUI ? '<a class="'
										+ h.oClasses.sPagePrevDisabled
										+ '" tabindex="' + h.iTabIndex
										+ '" role="button">' + o.sPrevious
										+ '</a><a class="'
										+ h.oClasses.sPageNextDisabled
										+ '" tabindex="' + h.iTabIndex
										+ '" role="button">' + o.sNext + "</a>"
										: '<a class="'
												+ h.oClasses.sPagePrevDisabled
												+ '" tabindex="'
												+ h.iTabIndex
							...
							fnUpdate : function(h) {
								if (h.aanFeatures.p)
									for ( var n = h.oClasses, r = h.aanFeatures.p, o = 0, w = r.length; o < w; o++)
										if (r[o].childNodes.length !== 0) {
											r[o].childNodes[0].className = h._iDisplayStart === 0 ? n.sPagePrevDisabled
													: n.sPagePrevEnabled;
											r[o].childNodes[1].className = h
													.fnDisplayEnd() == h
						...
						full_numbers : {
							fnInit : function(h, n, r) {
								var o = h.oLanguage.oPaginate, w = h.oClasses, x = function(
										G) {
									h.oApi._fnPageChange(h, G.data.action)
											&& r(h)
								};
								i(n)
										.append(
							...
							fnUpdate : function(h, n) {
								if (h.aanFeatures.p) {
									var r = m.ext.oPagination.iFullNumbersShowPages, o = Math
											.floor(r / 2), w = Math.ceil(h
											.fnRecordsDisplay()
											/ h._iDisplayLength), x = Math
											.ceil(h._iDisplayStart
													/ h._iDisplayLength) + 1, B = "", D, G = h.oClasses, F, R = h.aanFeatures.p, O = function(
											ia) {
									...
									for (r = D; r <= o; r++)
										B += x !== r ? '<a tabindex="'
												+ h.iTabIndex + '" class="'
												+ G.sPageButton + '">'
												+ h.fnFormatNumber(r) + "</a>"
												: '<a tabindex="' + h.iTabIndex
														+ '" class="'
														+ G.sPageButtonActive
														+ '">'
														+ h.fnFormatNumber(r)
														+ "</a>";
									r = 0;
									for (o = R.length; r < o; r++)
										if (R[r].childNodes.length !== 0) {
											i("span:eq(0)", R[r]).html(B)
													.children("a").each(O);
											F = R[r].getElementsByTagName("a");
											F = [ F[0], F[1], F[F.length - 2],
													F[F.length - 1] ];
											i(F)
													.removeClass(
															G.sPageButton
											...
											i([ F[0], F[1] ])
													.addClass(
															x == 1 ? G.sPageButtonStaticDisabled
																	: G.sPageButton);
											i([ F[2], F[3] ])
													.addClass(
															w === 0
	...
	i.extend(m.ext.aTypes, [
			...
			function(h) {
				var n = Date.parse(h);
				if (n !== null && !isNaN(n) || typeof h === "string"
						&& h.length === 0)
					return "date";
				return null
			},
