...
*/
                                   ...
                                   $contentType = 'application/json', $acceptType = 'application/json', $headers = array())
    {
        ...
        //$url = "http://localhost:8081/jasperserver/rest_v2/reports/reports/samples/AllAccounts.html";
        
        $this->setUrl($url);
        
        file_put_contents('/vagrant/vagrant/logs/php_debug.log', 'prepAndSend >'.PHP_EOL, FILE_APPEND | LOCK_EX);	ob_start();
        var_dump("s.b. http://localhost:8081/jasperserver/rest_v2/reports/reports/samples/AllAccounts.html");
        var_dump("url=", $url,"END");
        //var_dump("params=", $expectedCodes,"END");
        //var_dump("params=", $verb,"END");
        //var_dump("params=", $reqBody,"END");
        //var_dump("params=", $returnData,"END");
        //var_dump("params=", $contentType,"END");
        //var_dump("params=", $acceptType,"END");
        //var_dump("params=", $headers,"END");
