...
class UserController extends ReportFilterHelpers {
	...
	protected function saveAclCheckboxes($user_id) {
		...
		//TA:#415 if user unchecked all checkboxes in mechanism access than system just does nothing. Should we delete all records if user unchecked all checkboxes??????
