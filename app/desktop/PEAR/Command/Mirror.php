...
packages within preferred_state ({config preferred_state}) will be downloaded' 
	 ...
	 * @access public
	 * @param
	 *        	object PEAR_Frontend a reference to an frontend
	 * @param
	 *        	object PEAR_Config a reference to the configuration data
	 */
	 ...
	 *        	the command
	 * @param array $options
	 *        	the command options before the command
	 * @param array $params
	 *        	the stuff after the command name
	...
	function doDownloadAll($command, $options, $params) {
		...
		$err = $cmd->run ( 'download', array (
				'downloadonly' => true 
		), array_keys ( $remoteInfo ) );
